...
(function (factory) {
    ...
    k.o = function () {
        ...
        this.run = function () {
            ...
            this.o = $.extend({
                    ...
                    width: this.$.data('width') || 45,
                    height: this.$.data('height') || 45,
                    displayInput: this.$.data('displayinput') == null || this.$.data('displayinput'),
                    displayPrevious: this.$.data('displayprevious'),
                    fgColor: this.$.data('fgcolor') || '#fffece',
                    ...
                    // Knob
                    knobColor: this.$.data('knobcolor') || '#6c6c6c',
                    knobRadius: this.$.data('knobradius'),
                    knobShadow: this.$.data('knobshadow') || '#191919',
                    knobTipColor: this.$.data('knobtipcolor') || '#fff',
            ...
            if(this.o.knobRadius) {
                this.knobRadius=this.o.knobRadius;
            }
        ...
        this._configure = function () {
            ...
            if (this.o.class) this.cls = this.o.class;
    ...
    k.Dial = function () {
        ...
        this.init = function () {
            ...
            this.knobRadius = this.xy - this.lineWidth - 1;
        ...
        this.arc = function (v) {
          ...
          return {
              s: sa, //start
              e: ea, //end
              d: this.o.flip && !this.o.cursor //boolean
          };
        };
        ...
        this.draw = function () {
            ...
            // Knob:
            c.beginPath();
            c.fillStyle = this.o.knobShadow;
            c.arc(this.xy, this.xy, this.knobRadius, 0, Math.PI*2);
            c.fill();
            c.beginPath();
            c.fillStyle = this.o.knobColor ;
            c.arc(this.xy, this.xy, this.knobRadius-2, 0, Math.PI*2);
            c.fill();

            c.lineWidth=1;
            c.beginPath();
            c.strokeStyle = this.h2rgba("#ffffff", "0.4");
            c.arc(this.xy, this.xy, this.knobRadius-4, 0, Math.PI*2);
            c.stroke();
            

            c.lineWidth = wi;
            c.beginPath();
            c.strokeStyle = this.o.knobTipColor;
            var tipSize=Math.PI * 0.15;
            c.arc(this.xy, this.xy, this.knobRadius*0.6, a.e-tipSize/2, a.e+tipSize/2, false);
            c.stroke();
        };
